...
// let text = ["word", "exit", "trap"];
// let text2 = ["bla", "abl", "hdfhfh"];
...
// console.log(text.push("a"));
// console.log(text.splice(1, 1, "enter"));
...
//   totalSaleries += salaries[i];
// }
// console.log(totalSaleries);

// salaries.forEach((salary) => (totalSaleries += salary));
// console.log(totalSaleries);
